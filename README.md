...
![Screenshot](images/easy-weather-icons-font-v2-example-1.png)
...
(The above image shows just a sample of the icons that this font contains - download and open `easy_weather_icons_font-(fonts)/demo.html` in a browser or use Character Map in Windows to view the full .ttf icon set.)
...
Typically use as you would any other TrueType icon font (.ttf) (or please see details in the How to guides below) - for the separate icons you can also use the individual .svg image files included in `easy_weather_icons_font-(svg's)/SVG/`
...
[<img src="https://github.com/boxbot6/easy-weather-icons-font/raw/main/images/api-demo-screenshot-example-1.png" width="35%" />](images/api-demo-screenshot-example-1.png)
...
![Screenshot](images/easy-weather-icons-font-v2-example-3.png)
